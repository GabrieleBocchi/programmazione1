...
//////////////////////////////////////////
void stampatutti(const tree * t, const char * autore) {
  if (t != (tree *)NULL) {
    if (comparaautore(autore, t->info) == 0) {
      // In questo caso scendo solo su left, perche' per specifica
      // posso trovare solo a sinistra elementi con lo stesso autore,
      // e quindi evito di andare a cercare su right, evitando quindi
      // ricerche inutili.
